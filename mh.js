...
// Default: 5 - 180
var hornTimeDelayMin = 10;//10
var hornTimeDelayMax = 30;//30
...
var checkTimeDelayMin = 5;//5
var checkTimeDelayMax = 10;//10

// Play sound when encounter king's reward (true/false)
var isKingWarningSound = false;

// Auto solve KR
var isAutoSolve = true;//false
...
var showTimerInTitle = true;//false
...
var objTrapCollection = {
	weapon: ["2010 Blastoff", "2012 Big Boom", "500 Pound Spiked Crusher", "Admiral\'s Galleon", "Ambrosial Portal", "Ambush", "Ancient Box", "Ancient Gauntlet", "Ancient Spear Gun", "Anniversary Ambush", "Anniversary Ancient Box", "Anniversary Arcane Capturing Rod Of Never Yielding Mystery", "Anniversary DeathBot", "Anniversary Reaper\'s Perch", "Arcane Blast", "Arcane Capturing Rod Of Never Yielding Mystery", "Bandit Deflector", "Biomolecular Re-atomizer", "Birthday Candle Kaboom", "Birthday Party Piñata Bonanza", "Blackstone Pass", "Blazing Ember Spear", "Bottomless Grave", "Brain Extractor", "Bubbles: The Party Crasher", "Cackle Lantern", "Candy Crusher", "Carousel Charger", "Celestial Dissonance", "Cemetery Gate Grappler", "Chesla\'s Revenge", "Christmas Cactus", "Christmas Cracker", "Christmas Crystalabra", "Chrome Arcane Capturing Rod Of Never Yielding Mystery", "Chrome Celestial Dissonance", "Chrome DeathBot", "Chrome DrillBot", "Chrome Grand Arcanum", "Chrome MonstroBot", "Chrome Nannybot", "Chrome Oasis Water Node", "Chrome Onyx Mallet", "Chrome Phantasmic Oasis", "Chrome RhinoBot", "Chrome Sphynx Wrath", "Chrome Storm Wrought Ballista", "Chrome Tacky Glue", "Chrome Temporal Turbine", "Circlet of Pursuing", "Circlet of Seeking", "Clockapult of Time", "Clockapult of Winter Past", "Clockwork Portal", "Creepy Coffin", "Crystal Crucible", "Crystal Mineral Crusher", "Crystal Tower", "Darkest Chocolate Bunny", "Digby DrillBot", "Dimensional Chest", "Double Diamond Adventure", "Dragon Lance", "Dragon Slayer Cannon", "Dragonvine Ballista", "Dreaded Totem", "Droid Archmagus", "Ember Prison Core", "Endless Labyrinth", "Engine Doubler", "Enraged RhinoBot", "Event Horizon", "Explosive Toboggan Ride", "Father Winter\'s Timepiece", "Festive Forgotten Fir", "Festive Gauntlet Crusher", "Fluffy DeathBot", "Focused Crystal Laser", "Forgotten Pressure Plate", "Giant Speaker", "Gingerbread House Surprise", "Glacier Gatler", "Goldfrost Crossbow", "Golem Guardian", "Golem Guardian Arcane", "Golem Guardian Forgotten", "Golem Guardian Hydro", "Golem Guardian Physical", "Golem Guardian Tactical", "Gorgon", "Gouging Geyserite", "Grand Arcanum", "Grungy Deathbot", "Harpoon Gun", "Harrowing Holiday Harpoon Harp", "Haunted Shipwreck", "Heat Bath", "High Tension Spring", "HitGrab Horsey", "HitGrab Rainbow Rockin\' Horse", "HitGrab Rockin\' Horse", "Holiday Hydro Hailstone", "Horrific Venus Mouse", "Ice Blaster", "Ice Maiden", "Icy RhinoBot", "Infinite Labyrinth", "Infinite Winter Horizon", "Interdimensional Crossbow", "Isle Idol", "Judge Droid", "Kraken Chaos", "Law Laser", "Maniacal Brain Extractor", "Meteor Prison Core", "Moonbeam Barrier", "Mouse DeathBot", "Mouse Hot Tub", "Mouse Mary O\'Nette", "Mouse Rocketine", "Mouse Trebuchet", "Multi-Crystal Laser", "Mutated Venus Mouse", "Mysteriously unYielding Null-Onyx Rampart of Cascading Amperes", "Mystic Pawn Pincher", "Nannybot", "Net Cannon", "New Horizon", "New Year\'s Fireworks", "Ninja Ambush", "Nutcracker Nuisance", "NVMRC Forcefield", "Oasis Water Node", "Obelisk of Incineration", "Obelisk of Slumber", "Obvious Ambush", "Onyx Mallet", "Paradise Falls", "PartyBot", "Phantasmic Oasis", "Pneumatic Tube", "Pumpkin Pummeler", "Queso Factory", "Queso Fount", "Reaper\'s Perch", "Rewers Riposte", "RhinoBot", "Rift Glacier Gatler", "Rocket Propelled Gavel", "Rune Shark", "S.A.M. F.E.D. DN-5", "S.L.A.C.", "S.L.A.C. II", "S.S. Scoundrel Sleigher", "S.T.I.N.G.", "S.T.I.N.G.E.R.", "S.U.P.E.R. Scum Scrubber", "Sandcastle Shard", "Sandstorm MonstroBot", "Sandtail Sentinel", "Scarlet Ember Root", "School of Sharks", "Scum Scrubber", "Shrink Ray", "Sinister Portal", "Sleeping Stone", "Slumbering Boulder", "Smoldering Stone Sentinel", "Snow Barrage", "Snowglobe", "Soul Catcher", "Soul Harvester", "Sphynx Wrath", "Sprinkly Cupcake Surprise", "Stale Cupcake Golem", "Steam Laser Mk. I", "Steam Laser Mk. II", "Steam Laser Mk. II (Broken!)", "Steam Laser Mk. III", "Storm Wrought Ballista", "Supply Grabber", "Surprise Party", "Swiss Army Mouse", "Tacky Glue", "Tarannosaurus Rex", "Technic Pawn Pincher", "Temporal Turbine", "Terrifying Spider", "The Forgotten Art of Dance", "The Haunted Manor", "The Law Draw", "Thorned Venus Mouse", "Thought Manipulator", "Thought Obliterator", "Timesplit Dissonance", "Ultra MegaMouser MechaBot", "Veiled Vine", "Venus Mouse", "Wacky Inflatable Party People", "Warden Slayer", "Warpath Thrasher", "Well of Wisdom", "Wrapped Gift", "Zugzwang\'s First Move", "Zugzwang\'s Last Move", "Zugzwang\'s Ultimate Move", "Zurreal\'s Folly"],
	base: ["10 Layer Birthday Cake Base", "2017 New Year\'s Base", "2018 New Year\'s Base", "2019 New Year\'s Base", "2020 New Year\'s Base", "2021 New Year\'s Base", "Adorned Empyrean Refractor Base", "Ancient Booster Base", "Aqua Base", "Attuned Enerchi Induction Base", "Aurora Base", "Bacon Base", "Bamboozler Base", "Birthday Banana Cake Base", "Birthday Cake Base", "Birthday Confetti Cake Base", "Birthday Dragée Cake Base", "Birthday Ube Cake Base", "Black Widow Base", "Bronze Tournament Base", "Candy Cane Base", "Carrot Birthday Cake Base", "Cheesecake Base", "Chocolate Birthday Cake Base", "Claw Shot Base", "Clockwork Base", "Condemned Base", "Crushed Birthday Cake Base", "Cupcake Birthday Base", "Deadwood Plank Base", "Deep Freeze Base", "Dehydration Base", "Denture Base", "Depth Charge Base", "Desert Heater Base", "Dog Jade Base", "Dragon Jade Base", "Eerie Base", "Eerier Base", "Electromagnetic Meteorite Base", "Elixir Exchanger Base", "Enerchi Induction Base", "Explosive Base", "Extra Sweet Cupcake Birthday Base", "Fan Base", "Festive Winter Hunt Base", "Firecracker Base", "Fissure Base", "Fracture Base", "Furoma Base", "Gift of the Day Base", "Gingerbread Base", "Glowing Golem Guardian Base", "Golden Tournament Base", "Hallowed Ground Base", "Hearthstone Base", "Horse Jade Base", "Hothouse Base", "Jade Base", "Labyrinth Base", "Living Base", "Living Grove Base", "Magma Base", "Magnet Base", "Minotaur Base", "Molten Shrapnel Base", "Monkey Jade Base", "Monolith Base", "Overgrown Ember Stone Base", "Ox Jade Base", "Papyrus Base", "Physical Brace Base", "Pig Jade Base", "Polar Base", "Polluted Base", "Prestige Base", "Rat Jade Base", "Refined Pollutinum Base", "Remote Detonator Base", "Rift Base", "Rooster Jade Base", "Runic Base", "Seasonal Base", "Sheep Jade Base", "Signature Series Denture Base", "Silver Tournament Base", "Skello-ton Base", "Snake Jade Base", "Soiled Base", "Spellbook Base", "Spiked Base", "Sprinkly Sweet Cupcake Birthday Base", "Stone Base", "Tidal Base", "Tiki Base", "Treasure Seeker Base", "Tribal Base", "Tribal Kaboom Base", "Ultimate Iceberg Base", "Vegetation Base", "Washboard Base", "Wooden Base", "Wooden Base with Target", "Chocolate Bar Base"],
	bait: ["Abominable Asiago", "Ancient Cheese", "Ancient String Cheese", "Arctic Asiago Cheese", "Ascended Cheese", "Bland Queso", "Brie Cheese", "Brie String Cheese", "Candy Corn Cheese", "Checkmate Cheese", "Chedd-Ore Cheese", "Cheddar Cheese", "Cherry Cheese", "Cloud Cheesecake", "Coggy Colby Cheese", "Combat Cheese", "Creamy Havarti Cheese", "Crescent Cheese", "Crimson Cheese", "Crunchy Cheese", "Crunchy Havarti Cheese", "Cupcake Colby", "Dewthief Camembert", "Diamond Cheese", "Dragonvine Cheese", "Dumpling Cheese", "Duskshade Camembert", "Empowered Brie Cheese", "Empowered SUPER|brie+", "Extra Sweet Cupcake Colby", "Festive Feta", "Fishy Fromage", "Flamin\' Queso", "Fusion Fondue", "Galleon Gouda", "Gauntlet Cheese Tier 2", "Gauntlet Cheese Tier 3", "Gauntlet Cheese Tier 4", "Gauntlet Cheese Tier 5", "Gauntlet Cheese Tier 6", "Gauntlet Cheese Tier 7", "Gauntlet Cheese Tier 8", "Gauntlet String Cheese", "Gemstone Cheese", "Ghastly Galleon Gouda", "Ghoulgonzola Cheese", "Gilded Cheese", "Gingerbread Cheese", "Glazed Pecan Pecorino Cheese", "Glowing Gruyere Cheese", "Glutter Cheese", "Gnarled Cheese", "Gouda Cheese", "Graveblossom Camembert", "Grilled Cheese", "Gumbo Cheese", "Hot Queso", "Inferno Havarti Cheese", "Lactrodectus Lancashire Cheese", "Limelight Cheese", "Lockbox Limburger Cheese", "Lunaria Camembert", "Magical Havarti Cheese", "Magical Rancid Radioactive Blue Cheese", "Magical String Cheese", "Maki Cheese", "Maki String Cheese", "Marble Cheese", "Marble String Cheese", "Marshmallow Monterey", "Master Fusion Cheese", "Medium Queso", "Mild Queso", "Mineral Cheese", "Moon Cheese", "Mozzarella Cheese", "Nian Gao\'da Cheese", "Null Onyx Gorgonzola", "Nutmeg Cheese", "Onyx Gorgonzola", "Pecan Pecorino Cheese", "Polluted Parmesan Cheese", "Pungent Havarti Cheese", "Radioactive Blue Cheese", "Rainy Cheese", "Rancid Radioactive Blue Cheese", "Resonator Cheese", "Rewind Raclette", "Rift Combat Cheese", "Rift Glutter Cheese", "Rift Rumble Cheese", "Rift Susheese Cheese", "Riftiago Cheese", "Rockforth Cheese", "Rumble Cheese", "Runic Cheese", "Runic String Cheese", "Runny Cheese", "Seasoned Gouda", "Shell Cheese", "Sky Pirate Swiss Cheese", "Snowball Bocconcini", "Speedy Coggy Colby", "Spicy Havarti Cheese", "Sunrise Cheese", "SUPER|brie+", "Susheese Cheese", "Sweet Havarti Cheese", "Swiss Cheese", "Swiss String Cheese", "Terre Ricotta Cheese", "Undead Emmental", "Undead String Emmental", "Vanilla Stilton Cheese", "Vengeful Vanilla Stilton Cheese", "White Cheddar Cheese", "Wicked Gnarly Cheese", "Wildfire Queso", "Windy Cheese"],
	trinket: ["2014 Charm", "2015 Charm", "2016 Charm", "2017 Charm", "2018 Charm", "2019 Charm", "2020 Charm", "2021 Charm", "Airship Charm", "Amplifier Charm", "Ancient Charm", "Antiskele Charm", "Artisan Charm", "Athlete Charm", "Attraction Charm", "Baitkeep Charm", "Black Powder Charm", "Blue Double Sponge Charm", "Brain Charm", "Bravery Charm", "Cackle Charm", "Cactus Charm", "Candy Charm", "Champion Charm", "Cherry Charm", "Chrome Charm", "Clarity Charm", "Compass Magnet Charm", "Crucible Cloning Charm", "Cupcake Charm", "Dark Chocolate Charm", "Derr Power Charm", "Diamond Boost Charm", "Door Guard Charm", "Dragonbane Charm", "Dragonbreath Charm", "Dreaded Charm", "Dusty Coal Charm", "Eggscavator Charge Charm", "Eggstra Charge Charm", "Eggstra Charm", "Elub Power Charm", "Ember Charm", "EMP400 Charm", "Empowered Anchor Charm", "Enerchi Charm", "Extra Sweet Cupcake Charm", "Extreme Ancient Charm", "Extreme Attraction Charm", "Extreme Dragonbane Charm", "Extreme Luck Charm", "Extreme Party Charm", "Extreme Polluted Charm", "Extreme Power Charm", "Extreme Queso Pump Charm", "Extreme Regal Charm", "Extreme Snowball Charm", "Extreme Spooky Charm", "Extreme Wealth Charm", "Factory Repair Charm", "Festive Anchor Charm", "Festive Ultimate Luck Charm", "Festive Ultimate Lucky Power Charm", "Festive Ultimate Power Charm", "Firecracker Charm", "First Ever Charm", "Flamebane Charm", "Forgotten Charm", "Freshness Charm", "Gargantua Charm", "Gemstone Boost Charm", "Gift Wrapped Charm", "Gilded Charm", "Glowing Gourd Charm", "Gnarled Charm", "Golden Anchor Charm", "Golem Guardian Charm", "Greasy Glob Charm", "Growth Charm", "Grub Salt Charm", "Grub Scent Charm", "Grubling Bonanza Charm", "Grubling Chow Charm", "Horsepower Charm", "Hunter\'s Horn Rewind Charm", "Hydro Charm", "Lantern Oil Charm", "Let It Snow Charm", "Luck Charm", "Lucky Power Charm", "Lucky Rabbit Charm", "Lucky Valentine Charm", "Magmatic Crystal Charm", "Mining Charm", "Mobile Charm", "Monger Charm", "Monkey Fling Charm", "Nanny Charm", "Nerg Power Charm", "Nightlight Charm", "Nightshade Farming Charm", "Nitropop Charm", "Oxygen Burst Charm", "Party Charm", "Pointy Charm", "Polluted Charm", "Power Charm", "Prospector\'s Charm", "Queso Pump Charm", "Rainbow Luck Charm", "Ramming Speed Charm", "Reality Restitch Charm", "Realm Ripper Charm", "Red Double Sponge Charm", "Red Sponge Charm", "Regal Charm", "Rift 2020 Charm", "Rift 2021 Charm", "Rift Airship Charm", "Rift Antiskele Charm", "Rift Charm", "Rift Chrome Charm", "Rift Extreme Luck Charm", "Rift Extreme Power Charm", "Rift Extreme Snowball Charm", "Rift Luck Charm", "Rift Power Charm", "Rift Snowball Charm", "Rift Spooky Charm", "Rift Super Luck Charm", "Rift Super Power Charm", "Rift Super Snowball Charm", "Rift Tarnished Charm", "Rift Ultimate Luck Charm", "Rift Ultimate Lucky Power Charm", "Rift Ultimate Power Charm", "Rift Ultimate Snowball Charm", "Rift Vacuum Charm", "Rift Wealth Charm", "Roof Rack Charm", "Rook Crumble Charm", "Rotten Charm", "Safeguard Charm", "Scholar Charm", "Scientist\'s Charm", "Searcher Charm", "Shadow Charm", "Shamrock Charm", "Shattering Charm", "Sheriff\'s Badge Charm", "Shielding Charm", "Shine Charm", "Shortcut Charm", "Small Power Charm", "Smart Water Jet Charm", "Snakebite Charm", "Snowball Charm", "Soap Charm", "Softserve Charm", "Spellbook Charm", "Spiked Anchor Charm", "Sponge Charm", "Spooky Charm", "Spore Charm", "Sprinkly Sweet Cupcake Charm", "Stagnant Charm", "Stalemate Charm", "Sticky Charm", "Striker Charm", "Super Ancient Charm", "Super Attraction Charm", "Super Brain Charm", "Super Cactus Charm", "Super Dragonbane Charm", "Super Enerchi Charm", "Super Lantern Oil Charm", "Super Luck Charm", "Super Nightshade Farming Charm", "Super Party Charm", "Super Polluted Charm", "Super Power Charm", "Super Queso Pump Charm", "Super Regal Charm", "Super Rift Vacuum Charm", "Super Rotten Charm", "Super Salt Charm", "Super Snowball Charm", "Super Soap Charm", "Super Spooky Charm", "Super Spore Charm", "Super Warpath Archer Charm", "Super Warpath Cavalry Charm", "Super Warpath Commander\'s Charm", "Super Warpath Mage Charm", "Super Warpath Scout Charm", "Super Warpath Warrior Charm", "Super Wax Charm", "Super Wealth Charm", "Supply Schedule Charm", "Tarnished Charm", "Taunting Charm", "Timesplit Charm", "Torch Charm", "Treasure Trawling Charm", "Ultimate Anchor Charm", "Ultimate Ancient Charm", "Ultimate Attraction Charm", "Ultimate Charm", "Ultimate Luck Charm", "Ultimate Lucky Power Charm", "Ultimate Party Charm", "Ultimate Polluted Charm", "Ultimate Power Charm", "Ultimate Snowball Charm", "Ultimate Spooky Charm", "Ultimate Spore Charm", "Ultimate Wealth Charm", "Uncharged Scholar Charm", "Unstable Charm", "Valentine Charm", "Warpath Archer Charm", "Warpath Cavalry Charm", "Warpath Commander\'s Charm", "Warpath Mage Charm", "Warpath Scout Charm", "Warpath Warrior Charm", "Water Jet Charm", "Wax Charm", "Wealth Charm", "Wild Growth Charm", "Winter Builder Charm", "Winter Charm", "Winter Hoarder Charm", "Winter Miser Charm", "Winter Screw Charm", "Winter Spring Charm", "Winter Wood Charm", "Yellow Double Sponge Charm", "Yellow Sponge Charm"]
};
...
var objBestTrap = {
    weapon: {
        ...
        shadow: ['Temporal Turbine', 'Clockwork Portal', 'Reaper\'s Perch', 'Dreaded Totem', 'Candy Crusher', 'Clockapult of Time', 'Clockapult of Winter Past'],
...
var g_objConstTrap = {
    bait: {
        ...
        ANY_MASTER: {
            sort: 'any',
            name: ['Rift Susheese', 'Rift Combat', 'Rift Glutter', 'Master Fusion Cheese']
        },
        ANY_LUNAR: {
            sort: 'any',
    ...
    trinket: {
        GAC_EAC: {
            sort: 'best',
            name: ['Golden Anchor', 'Empowered Anchor', 'Festive Anchor Charm']
        },
        SAC_EAC: {
            sort: 'best',
            name: ['Spiked Anchor', 'Empowered Anchor', 'Festive Anchor Charm']
        },
        UAC_EAC: {
            sort: 'best',
            name: ['Ultimate Anchor', 'Spiked Anchor', 'Empowered Anchor', 'Festive Anchor Charm']
        },
        'ANCHOR_FAC/EAC': {
            sort: 'best',
...
function labyrinth() {
    if (GetCurrentLocation().indexOf("Labyrinth") < 0)
        return;
    /*var loc = GetCurrentLocation();
    if (loc.indexOf("Zokor") > -1) {
        setStorage('eventLocation', 'Zokor');
        zokor();
        return;
    }
    else if (loc.indexOf("Labyrinth") < 0)
        return;*/

    var labyStatus = getPageVariable("user.quests.QuestLabyrinth.status");
    var isAtEntrance = false;//(labyStatus == "intersection entrance");                                        //remove once done
    var isAtHallway = (labyStatus == "hallway");
    var isAtIntersection = ((labyStatus == "intersection") || (labyStatus == "intersection entrance"));        //remove once done
    ...
    if (isAtExit) {                                                                                               //remove when done
        ...
        checkThenArm('best', 'bait', ['Glowing Gruyere Cheese', 'Gouda', 'Brie']);                                 //remove when done
    }//remove when done
...
function fw() {
    ...
    if (objFW.special[objFW.streak] == 'COMMANDER') {
        if (objFW.streak >= 7)    //Take Away once done
...
function fRiftArmTrap(obj, nIndex, bReadJournal) {
    ...
    else if (obj.bait[nIndex] == 'Maki String') {
        checkThenArm('best', 'bait', ['Maki String Cheese', 'Brie String Cheese']);
    }
    else if (obj.bait[nIndex] == 'Ascended Cheese') {
        checkThenArm('best', 'bait', ['Ascended Cheese', 'Null Onyx Gorgonzola', 'Rift Rumble Cheese']);
    }
    else if (obj.bait[nIndex] == 'Null Onyx Gorgonzola') {
        checkThenArm('best', 'bait', ['Null Onyx Gorgonzola', 'Rift Rumble Cheese']);
    }
    else
    ...
    var intervalCTATI = setInterval(
        function () {
            ...
            if (armStatus != LOADING) {
                ...
                //else                                                                                           //Take Away Once Done.
                //window.setTimeout(function () { reloadPage(false); }, 5000);                               //Take Away Once Done.
                return;
            }
            else {
                --sec;
    ...
    if (showTimerInPage) {
        ...
        if (headerElement) {
            ...
            if (targetPage && aggressiveMode)
                titleElement.innerHTML = "<a href=\"https://github.com/lejen-code/mh\" target=\"_blank\"><b>MouseHunt AutoBot (version " + g_strVersion + " Lejen Custom Edition)</b></a> - <font color='red'>Aggressive Mode</font>";
            else if (targetPage && browser != 'chrome' && browser != 'opera')
                titleElement.innerHTML = "<a href=\"https://github.com/lejen-code/mh\" target=\"_blank\"><b>MouseHunt AutoBot (version " + g_strVersion + " Lejen Custom Edition)</b></a> - <font color='red'><b>Pls use Chrome browser for fully working features</b></font>";
            else
                titleElement.innerHTML = "<a href=\"https://github.com/lejen-code/mh\" target=\"_blank\"><b>MouseHunt AutoBot (version " + g_strVersion + " Lejen Custom Edition)</b></a>";
            ...
            sponsorLine.innerHTML = '<a href="https://github.com/sponsors/lejen-code" target=\"_blank\">Consider sponsoring this project</a>';
            ...
            preferenceHTMLStr += '<option value="Empowered Brie">Empowered Brie</option>';
            ...
            preferenceHTMLStr += '<option value="Chrome Celestial Dissonance">Chrome Celestial</option>';
            preferenceHTMLStr += '<option value="Celestial Dissonance">Celestial</option>';
            preferenceHTMLStr += '<option value="Timesplit Dissonance">Timesplit</option>';
            preferenceHTMLStr += '<option value="Mysteriously unYielding">MYNORCA</option>';
            preferenceHTMLStr += '<option value="Focused Crystal Laser">Focused Crystal</option>';
            preferenceHTMLStr += '<option value="Multi-Crystal Laser">Multi-Crystal</option>';
            preferenceHTMLStr += '<option value="Biomolecular Re-atomizer">Biomolecular</option>';
            preferenceHTMLStr += '<option value="Crystal Tower">Crystal Tower</option>';
            preferenceHTMLStr += '<option value="Christmas Crystalabra">Crystalabra</option>';
            preferenceHTMLStr += '<option value="Wacky Inflatable Party People">Wacky</option>';
...
function CallKRSolver() {
    ...
    if (debugKR) {
        ...
        if (isNewUI) {
            ...
            frame.src = document.getElementsByClassName('mousehuntPage-puzzle-form-captcha-image')[0].getElementsByTagName('img')[0].src;
        }
        else {
